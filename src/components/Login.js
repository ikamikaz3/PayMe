...
class LoginComponent extends Component {
  ...
  render() {
    ...
    return (
      ...
      >
               <Image style={styles.avatar} source={{uri: 'https://img.freepik.com/free-vector/hand-holding-smartphone-scan-qr-code-pay_32996-137.jpg?size=338&ext=jpg'}}/>
      ...
      <View style={styles.inputContainer}>
        ...
        title="Login" onPress={() => loginAction(email, password)} >
        <Text>Login</Text>
        ...
        <TouchableOpacity style={[styles.buttonContainer, styles.notRegisterStyle]} 
